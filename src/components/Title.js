const Title = () => {
    return (
        <div className="text-center mt-5">
            <h1 className="fw-bold display-4 text-light title-effect">react-use-form-lite</h1>
            <p className="fs-5 mx-auto" style={{ maxWidth: "800px", lineHeight: "1.4", color: "#fff", opacity: "0.7" }}>
